...
import PlayerFanDeal from "../../Components/Player/PlayerFanDeal";
...
import ScoutPaymentSuccess from "../../Components/Scout/ScoutPaymentSuccessful";
  ...
  return (
    <div className="max-w-[1400px] shadow-lg mx-auto">
      ...
      <Routes>
        ...
        <Route path="/fan/dealsmade/:id" element={<FanDealsMade />} />
      </Routes>
      {/* </div> */}
      <Footer />
    </div>
