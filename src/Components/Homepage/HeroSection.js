...
const HeroSection = () => {
  ...
  return (
    <div className="heroSection_background max-h-[90vh] ">
      {/* <div
      ...
      /> */}
      <div className="HeroSec_TextSection ml-10 pt-20 flex flex-col">
        <p className='text-6xl text-[#071A10] font-bold'>Brightest African Football Talents</p>
        <p className='text-[#071A10] text-lg w-[400px] mt-5'>We vert qualified and the most talented African players from all over the continent.</p>
