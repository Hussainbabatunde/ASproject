...
const AdminTalentManagerSuspended = ({handleAllNegotiate, handleSuspended, handleClosed, handleTerminated}) => {
    const header= [
        {
            id:1,
            name:'Player Name'
  ...
  return (
    <div className='AdminPage_NegotiateTab'>
      <div className='AdminPage_NegotiateTabTitle'>
        <p className='AdminPAge_Negotiate_TalentManagerNegotiateInactive' onClick={handleAllNegotiate}>All Talent Manager</p>
