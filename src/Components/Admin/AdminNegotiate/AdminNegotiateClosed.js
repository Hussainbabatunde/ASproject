...
const AdminNegotiateClosed = ({handleAllNegotiate, handleSuspended, handleClosed, handleTerminated}) => {
  ...
  return (
    <div className='AdminPage_NegotiateTab'>
      <div className='AdminPage_NegotiateTabTitle'>
        ...
        <p className='AdminPAge_Negotiate_TabNegotiateActive' onClick={handleClosed}>Closed <span className='AdminPage_NegotiateTab_TabNumber'>10k</span></p>
...
export default AdminNegotiateClosed