...
const AdminNegotiateTerminated = ({handleAllNegotiate, handleSuspended, handleClosed, handleTerminated}) => {
...
const dataTable= [
  ...
  return (
    ...
    <div className='AdminPage_TerminatedTableInfo'>
      ...
      <span className='AdminPage_TableInfoText'>This is a table of Terminated Negotiates on the platform</span>
    </div>
...
export default AdminNegotiateTerminated