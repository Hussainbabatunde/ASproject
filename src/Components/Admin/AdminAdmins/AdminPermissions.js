...
import {
  AdminAllPermissionsRequest,
  AdminDeletePermissionsRequest,
  AdminGetAllPermissionsRequest,
  AdminGetIndividualPermissionsRequest,
  AdminPutIndividualPermissionsRequest,
} from "../../../Slice/Admin/AdminAllAdmins/AdminPermissionSlice";
...
const AdminPermissions = () => {
  ...
  const UserInitialInfo = useSelector(
    (state) =>
      state?.reducer?.AdminAllAdminSlice?.GetAdminPermissionIndidata?.data
  );
    ...
    <div className="AdminDashboard">
      ...
      <div className="AdminPage_Dashboard">
        <div className="AdminPage_DashboardTAbleCat">
          <button className="Adminpage_CreateAdmins" onClick={handleShow}>
            Create Permission
          </button>
