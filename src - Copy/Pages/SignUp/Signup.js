...
const Signup = () => {
    const data= [
        {accType: 'Player', image: iconsSoccerPlayer, accDetails:'Grow and monetize your brand', value:'/create-account/player'},
        {accType:'Scout', image: iconsPersonaltrainer, accDetails:'Scout and book players', value: '/create-account/scout'},
        {accType:'Fan', image: iconscheerleader, accDetails: 'Reach out to your favorite players', value:'/create-account/fan'},
        {accType:'Talent Manager', image: iconsManager, accDetails: 'Support and manager players', value:'/create-account/manager'}
    ]
  return (
    <div className='Loginpage'>
        ...
        <form className='Loginpage_formSection'>
            ...
            {data.map((each, index)=>(
            <Link to={each?.value} className='SignupPage_DifferentAcc' key={index}>
